<nav x-data="{ open: false }" class="sticky top-0 z-50 glass-panel shadow-sm transition-all">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6 gap-4">
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-gray-200 shadow-sm text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden bg-white/90 backdrop-blur-md">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('user.pickup')" :active="request()->routeIs('user.pickup')">
                {{ __('Request Pickup') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('user.redeem')" :active="request()->routeIs('user.redeem')">
                {{ __('Redeem Center') }}
            </x-responsive-nav-link>
