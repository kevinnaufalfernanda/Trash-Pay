    ...
    <div class="py-12">
        <div class="max-w-[90rem] mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 lg:grid-cols-6 gap-4 mb-8">
                <div class="glass-panel rounded-3xl p-5 text-center flex flex-col items-center">
            ...
            <div class="grid md:grid-cols-3 gap-6">
                ...
                <a href="{{ route('admin.analytics') }}" class="glass-panel rounded-3xl p-8 text-center hover:border-primary hover:bg-white/60 transition-all group flex flex-col items-center">
                ...
                <a href="{{ route('admin.pricing') }}" class="glass-panel rounded-3xl p-8 text-center hover:border-amber-400 hover:bg-white/60 transition-all group flex flex-col items-center">
                ...
                <a href="{{ route('admin.payouts') }}" class="glass-panel rounded-3xl p-8 text-center hover:border-amber-400 hover:bg-white/60 transition-all group flex flex-col items-center relative">
                    @if($pendingPayouts > 0)
