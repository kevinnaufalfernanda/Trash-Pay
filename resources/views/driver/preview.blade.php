        ...
        <div class="max-w-[90rem] mx-auto sm:px-6 lg:px-8">
            <div class="grid md:grid-cols-3 gap-6">
                ...
                <div class="glass-panel rounded-3xl p-8 flex flex-col justify-between">
                    <div>
                        <h3 class="text-2xl font-serif font-bold mb-6 text-secondary">Detail Penjemputan</h3>
                        <div class="space-y-4">
                            ...
                            <div class="bg-white/40 p-4 rounded-2xl border border-white/60 shadow-sm">
                                <span class="text-xs text-gray-500 uppercase font-bold tracking-wider">Estimasi</span>
                            ...
                            <div class="bg-white/40 p-4 rounded-2xl border border-amber-200 shadow-sm bg-amber-50">
                                <span class="text-xs text-amber-600 uppercase font-bold tracking-wider">Potensi Koin</span>
